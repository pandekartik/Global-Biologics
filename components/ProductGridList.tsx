      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
        {products.map((prod, i) => (
          <div key={i} className="flex flex-col group relative">
            ...
            <div className="aspect-[4/3] bg-white border border-slate-200 rounded-t-lg overflow-hidden p-4 flex items-center justify-center relative overflow-hidden group">
              <img 
